...
export type StartGame = SocketMessage<typeof RequestTypes.ServerActions.LoadGame, Omit<LobbyDetails, 'players'>, typeof Services.Player>;
...
export const isStartGame = (msg: SocketMessage): msg is StartGame => msg.action === RequestTypes.ServerActions.LoadGame;
